                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="dep" items="${depList}">
	                    <tr>
	                        ...
	                        <td>
	                        <shiro:hasPermission name="baoxiao:remove">  </shiro:hasPermission>
                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="pd" items="${pdList}">
	                    <tr>
	                        ...
	                        <td>
	                        <shiro:hasPermission name="baoxiao:viewimage">   </shiro:hasPermission>
	                          <a target="_blank" href="viewImage1?deploymentId=${pd.deploymentId}&imageName=${pd.diagramResourceName}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-eye-open"></span> 查看流程定义图</a>
