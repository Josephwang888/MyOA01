...
<div class="page-content">
				...
				<div class="modal-body">
					<table class="table table-bordered table-striped" width="800px">
						...
						<tr>
							<td>类型</td>
							<td>
							    <select class="form-control" name="type" id="cho" onchange="getChange(this.value)">
						...
						<tr>
						    ...
						    <td>
						    	...
						    	<select class="form-control" name="parentid" id="asa">
										<option value="1">权限</option>
								</select>
						    </td>
						</tr>
	...
	<script type="text/javascript">
		function getChange(type) {
			if(type == 'menu'){
				$("#asa").html('<option value="1">权限</option>');
			}else {
				$("#asa").html("<c:forEach var='menu' items='${menuTypes}'> <option value='${menu.id}'>${menu.name}</option> </c:forEach>");
			}
		}
	</script>
